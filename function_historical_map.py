...
class classifyImage:
    ...
    def predict_image(
        self, inRaster, outRaster, model, inMask=None, NODATA=-10000, SCALE=None
    ):
        ...
        if raster is None:
            print(f"Impossible to open {inRaster}")
            exit()
...
class progressBar:
    ...
    def __init__(self, inMsg: str = " Loading...", inMaxStep: int = 1):
